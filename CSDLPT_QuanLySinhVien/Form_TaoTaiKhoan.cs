...
namespace CSDLPT_QuanLySinhVien
{
    public partial class Form_TaoTaiKhoan : Form
    {
        ...
        {
            LoadDataNHANVIEN();
            rB_GiangVien.Enabled = rB_ChuyenVien.Enabled = rB_User.Enabled = false;
            if (Program.mGroup == "CHUYENVIEN")
            {
                rB_ChuyenVien.Enabled = true;
            }
            else if (Program.mGroup == "USER")
            {
                rB_GiangVien.Enabled = rB_GiangVien.Enabled = rB_ChuyenVien.Enabled = rB_User.Enabled = true;
            }
            else if (Program.mGroup == "GIANGVIEN" || Program.mGroup == "BANHANG" || Program.mGroup == "KHO" || Program.mGroup == "SANPHAM")
            {
                rB_GiangVien.Enabled = rB_ChuyenVien.Enabled = rB_User.Enabled = false;
            }
        }
        ...
        //        return;
        //    if (!(rB_CongTy.Checked || rB_GiangVien.Checked || rB_Kho.Checked || rB_ChuyenVien.Checked || rB_User.Checked || rB_BanHang.Checked))
        //    {
